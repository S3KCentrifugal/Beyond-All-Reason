...
namespace ObjectiveHelpers {
    ...
    bool StepEcoSatisfied(const Objectives::ObjectiveStep@ s)
    {
        ...
        if (s.minMetalIncome > 0 && Global::Economy::MetalIncome < s.minMetalIncome) return false;
        if (s.minEnergyIncome > 0 && Global::Economy::EnergyIncome < s.minEnergyIncome) return false;
        return true;
    }
    ...
    if (IsCompleted(o.id)) return false;
        ...
        if (o.minMetalIncome > 0 && Global::Economy::MetalIncome < o.minMetalIncome) return false;
        if (o.minEnergyIncome > 0 && Global::Economy::EnergyIncome < o.minEnergyIncome) return false;
        return true;
    }
