...
namespace RoleTech {
    ...
    ******************************************************************************/    
    ...
    IUnitTask@ Tech_BuilderAiMakeTask(CCircuitUnit@ u) {
        ...
        {
            if (defaultTask.GetType() == Task::Type::BUILDER) {
    ...
    ******************************************************************************/
    ...
    IUnitTask@ Tech_T1Constructor_AiMakeTask(CCircuitUnit@ u, float metalIncome, float energyIncome) {
        ...
        if (u is Builder::primaryT1BotConstructor) {
            ...
            GenericHelpers::LogUtil(
                "[TECH] T1AirPlant check: metalIncome=" + metalIncome + " energyIncome=" + energyIncome + " metalCurrent=" + Global::Economy::MetalCurrent +
    ...
    IUnitTask@ Tech_T2Constructor_AiMakeTask(CCircuitUnit@ u, bool isEnergyFull, float metalIncome, float energyIncome, float metalCurrent, bool isEnergyLessThan90Percent) {
        ...
        if (EconomyHelpers::ShouldSecondaryT2AssistPrimary(
            /*metalIncome*/ Global::Economy::MetalIncome,
    ...
    IUnitTask@ Recycle(CCircuitUnit@ u, float metalIncome) {
        GenericHelpers::LogUtil(
            ...
            " MetalCurrent=" + Global::Economy::MetalCurrent + " metalIncome=" + metalIncome, 4
        );
        ...
        if(Factory::IsT2LabBuildQueued() && Global::Economy::MetalCurrent < 600.0f && t1CtorCountForRecycle >= 3 && metalIncome <= 45.0f) {
        ...
        if ((Builder::IsAdvancedFusionBuildQueued() || Builder::IsNukeSiloBuildQueued()) && Global::Economy::MetalCurrent < 600.0f) {
