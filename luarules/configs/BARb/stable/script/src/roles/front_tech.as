...
namespace RoleFrontTech {
    ...
    ******************************************************************************/ 
    ...
    if (udef is null) return Builder::MakeDefaultTaskWithLog(u.id, "FRONT_TECH");

        // Route T1 bot constructors to FrontTech logic; others fallback
        ...
        if (ctorTier == 1) {
            if (u is Builder::primaryT1BotConstructor || u is Builder::secondaryT1BotConstructor) {
                return FrontTech_T1Constructor_AiMakeTask(u);
            } else {
    ...
    return Builder::MakeDefaultTaskWithLog(u.id, "FRONT_TECH");
    }
    ...
    ******************************************************************************/ 
    ...
    IUnitTask@ FrontTech_T1Constructor_AiMakeTask(CCircuitUnit@ u) {
        // Econ snapshot
        ...
        if (u is Builder::primaryT1BotConstructor) {
            ...
            if (EconomyHelpers::ShouldBuildT1EnergyConverter(
                /*metalIncome*/ mi,
                /*energyIncome*/ ei,
                /*energyCurrent*/ Global::Economy::EnergyCurrent,
                /*energyStorage*/ Global::Economy::EnergyStorage,
